...
public class Storage {
    ...
    public void writeCSV(HashMap<Object, List<String>> map) throws IOException { // read the cvs and initial the easy hashmap
        try {
    ...
    public HashMap<Object, List<String>> readCSV(String path) { // transfer the hashmap to csv file stored in the file system.
        HashMap<Object, List<String>> map = new HashMap<>();
        try {
